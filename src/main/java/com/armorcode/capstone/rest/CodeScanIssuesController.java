...
@RestController
public class CodeScanIssuesController {
...
//                System.out.println("success");
    ...
    @GetMapping("/issues/codescan/closed")
    public ResponseEntity<?> updateAlertStatus(@RequestParam long id) throws ClientProtocolException, IOException {
        ...
        String apiUrl = STR."https://api.github.com/repos/praveen-kr-22/vulnerable-repo/code-scanning/alerts/\{number}";
        try {
            ...
            String requestBody = "{\"state\":\"dismissed\",\"dismissed_reason\":\"false positive\",\"dismissed_comment\":\"This alert is accurate but we use a sanitizer.\"}";
